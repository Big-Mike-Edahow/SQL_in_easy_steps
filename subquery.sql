...
CREATE TABLE IF NOT EXISTS customers ( acc_num INT PRIMARY KEY, name	CHAR(20) NOT NULL );
...
CREATE TABLE IF NOT EXISTS orders ( ord_num INT PRIMARY KEY, acc_num INT NOT NULL );
...
SELECT ord_num, customers.acc_num, name FROM customers, orders WHERE customers.acc_num = orders.acc_num AND orders.ord_num = 4;
